...
<div class="container-fluid">
  ...
  <a href="<?= base_url('master/employee'); ?>"
    class="btn btn-light bg-gradient-light border btn-icon-split mb-4 rounded-0">
    ...
    <div class="row justify-content-center">
      <div class="col-lg-3">
        <div class="card rounded-0 shadow" style="width: 100%; height: 100%">
          <img src="/els/images/pp/<?= $employee['image']; ?>" class="card-img-top w-75 mx-auto pt-3">
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" readonly class="form-control-plaintext" name="e_id"
                    value="<?= $employee['id']; ?>">
                </div>
              </div>
              <div class="col-lg-8">
            ...
            <div class="row">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <div class="col-lg p-0">
                    <input type="date" class="form-control" name="e_birth_date" id="e_birth_date" min="1990-01-01"
                      max="2002-01-01" value="<?= $employee['birth_date']; ?>">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <div class="col-lg p-0">
                    <input type="date" class="form-control" name="e_hire_date" id="e_hire_date" min="2004-04-16"
                      max="<?= date('Y-m-d', time()); ?>" value="<?= $employee['hire_date']; ?>">
                  ...
                  <select class="form-control" name="s_id" id="s_id">
                    <?php foreach ($shift as $sft): ?>
                      <option value="<?= $sft['id'] ?>" <?php if ($sft['id'] == $employee['shift_id']) {
                        ...
                        ; ?>><?= $sft['id'] ?> <small>(
                          <?= date("h:i A", strtotime('2022-06-23 ' . $sft['start'])) ?> -
                          <?= date("h:i A", strtotime('2022-06-23 ' . $sft['end'])) ?>)
                        </small>
                      </option>
                    <?php endforeach; ?>
                  </select>
