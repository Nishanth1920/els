...
<div class="container-fluid">
  ...
  <a href="<?= base_url('master/location'); ?>"
    ...
    <form action="" method="POST" class="col-lg-5 col-md-6 col-sm-12 col-xs-12 p-0">
      <div class="card rounded-0">
        ...
        <div class="card-body">
          ...
          <button type="submit" class="btn btn-sm btn-primary bg-gradient-primary btn-icon mt-4 float-right rounded-0">
            <span class="icon text-white">
